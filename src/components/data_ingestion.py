...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        logging.info("Entered initiate_data_ingestion component")
        try:
...
if __name__ == "__main__":
    ...
    model_trainer.initiate_model_trainer(train_arr, test_arr, preprocessor_path=os.path.join("artifacts", "preprocessor.pkl"))